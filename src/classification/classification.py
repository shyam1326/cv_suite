...
class Image_classification():
    ...
    def data_loader(self, data_transform, batch_size):
        ...
        # Load the data
        data_loader = {
            "train": DataLoader(data_transform["train"], batch_size=batch_size, shuffle=True, num_workers=2),
            "val": DataLoader(data_transform["val"], batch_size=batch_size, shuffle=True, num_workers=2)
        }
        return data_loader
